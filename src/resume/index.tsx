      ...
      <div className={styles.wrapper}>
        <div className={styles.page}>
              ...
              <div className={styles.work}>
                ...
                <div className={styles.main}>
                  <div className={styles.name}>
                    蚂蚁集团
                    <span className={styles.tech}>React16.8  TS  微前端</span>
                  </div>
                  <div className={styles.desc}>2022.08 ~ 2022.10（2个月） ｜ 成都 体验技术部 ｜ 高级前端工程师</div>
                  <div className={styles.content}>
            ...
            <div className={styles.block}>
              <div className={styles.work}>
                ...
                <div className={styles.main}>
                  <div className={styles.name}>
                    拼多多
                    <span className={styles.tech}>React16.8  TS  Taro  微前端  SSR  CSR</span>
                  </div>
            ...
            <div className={styles.block}>
              <div className={styles.work}>
                ...
                <div className={styles.main}>
                  <div className={styles.name}>
                    小红书
                    <span className={styles.tech}>Vue2  JS  WePY  CSR</span>
                  </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.block}>
              <div className={styles.name}>
                拼多多 <a target="_blank" href="https://pifa.pinduoduo.com/">批发市场</a>
              </div>
              <div className={styles.desc}>
                2020年下半年 ～ 2021年下半年
              </div>
